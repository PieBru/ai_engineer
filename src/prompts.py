...
system_PROMPT = dedent("""\
    ...
    **Examples of Handling Simple Greetings (YOU MUST FOLLOW THESE PRECISELY):**
    ...
    3. Network Operations (via function calls):
       ...
       **IMPORTANT: When communicating with the user, DO NOT refer to these tool names.** Instead, describe the action you are taking (e.g., "I will connect to the local server", "I will monitor the remote service").
